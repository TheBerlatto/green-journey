...
public class MissaoAtDAO {
    ...
    public void inserirMissaoAt(String username) throws Exception {
        ...
        try (Connection conn = ConnectionFactory.obtemConexao(); PreparedStatement stmtUsuario = conn.prepareStatement(sqlPessoa); PreparedStatement stmtMissao = conn.prepareStatement(sqlMissao)) {
    ...
    public MissaoAtribuida[] obterMissoesAt(int idPessoa) throws Exception {
        String sql = "SELECT * FROM tb_missaoAt WHERE id_pessoa = ? ;";
    ...
    public void inserirMissaoAtPorId(int idMissao) throws Exception {
        ...
        try (Connection conn = ConnectionFactory.obtemConexao(); PreparedStatement stmtUsuarios = conn.prepareStatement(sqlUsuarios); PreparedStatement stmtInsert = conn.prepareStatement("INSERT INTO tb_missaoAt (id_pessoa, id_missao, finalizada) VALUES (?, ?, ?)")) {
